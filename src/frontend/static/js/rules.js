...
function deleteRule(ruleId, ruleName) {
    ...
    showModal({
        title: 'Delete Rule',
        message: `Are you sure you want to delete the rule <strong>"${ruleName}"</strong>?<br><br>This action cannot be undone.`,
        confirmText: 'Delete',
        cancelText: 'Cancel',
        variant: 'danger',
        onConfirm: () => {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    showModal({
                        title: 'Error',
                        message: 'Error deleting rule: ' + (data.message || 'Unknown error'),
                        confirmText: 'OK',
                        variant: 'danger',
                        onConfirm: () => {},
                    });
